    ...
    return (
        <div className='mt-0'>
            ...
            <div className='flex justify-end mt-4 gap-2'>
                <button className='border px-1 py-1 rounded-full text-sm font-medium'>
                    Cancel
                </button>
                <button className='bg-yellow-400 text-black px-1 py-1 rounded-full text-sm font-semibold shadow'>
                    Save workflow
                </button>
            </div>
        </div>
